...
#
# 'make' is here specifically so a project generated by
# tools.scaffold.tools.ProjectScaffoldTool (C/C++ skeletons ship a
# Makefile) is actually buildable through process_run, not just
# generated — see docs/RUNTIMES.md.
